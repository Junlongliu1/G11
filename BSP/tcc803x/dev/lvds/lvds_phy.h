...
#ifndef __LVDS_PHY_H__
#define	__LVDS_PHY_H__
...
extern void LVDS_PHY_Init(uint32 lvds_type, uint32 lvds_main, uint32 lvds_sub, uint32 upsample_ratio, uint32 ref_cnt, uint32 vcm, uint32 vsw, uint32 *LVDS_LANE_MAIN, uint32 *LVDS_LANE_SUB); //compiler warning
#endif
