/*
 * linux/include/video/tcc/lvds_wrap.h
 * Author:  <linux@telechips.com>
 * Created: June 10, 2008
 * Description: LVDS WRAP h/w block 
 *
...
#define LVDS_WRAP_ACCESS_CODE		(0x1ACCE551)
...
extern void LVDS_WRAP_ResetPHY(uint32 port, uint32 reset); //compiler warning
extern void LVDS_WRAP_Set(uint32 lvds_type, uint32 val, uint32 select, uint32 sel0[TXOUT_MAX_LINE][TXOUT_DATA_PER_LINE], uint32 sel1[TXOUT_MAX_LINE][TXOUT_DATA_PER_LINE]);//compiler warning
#endif
